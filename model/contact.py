...
class Contact:
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:(%s:%s:%s):{%s:%s:%s:%s}" % (self.id, self.last_name, self.first_name, self.address,
                                                         self.email_1, self.email_2, self.email_3, self.home_phone,
                                                         self.mobile_phone, self.work_phone, self.phone_2)
